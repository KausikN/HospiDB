 ...
 * @author Kausik N
 */
public class Table_Delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(270, 270, 890, 390);
        ...
        column_dropdown.setFont(new java.awt.Font("Calibri", 0, 25)); // NOI18N
        ...
        value_text.setFont(new java.awt.Font("Calibri", 0, 25)); // NOI18N
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(910, 100, 250, 160);

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select Table", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 0, 20))); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(table_dropdown, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(23, 23, 23))
        );

        jPanel1.add(jPanel3);
        jPanel3.setBounds(270, 170, 300, 90);
...
void FindAccesibleTables(String category){
    if(category.equals("Admin")){
        ...
        deletable_tables[2] = "PatientReport";
...
void MySQLConnector_Delete(){
    ...
    for(int i=1;i<columns_in_table_size;i++){
        for(int j=0;j<t1.getSelectedRowCount();j++){
            s = "delete from "+Table+" where "+columns_in_table[0]+" = '"+Selected_Ids[j]+"';";
            st1.executeUpdate(s);   
        }
    } 
    con.close();
...
Table_Delete.this.setVisible(false);
h.setVisible(true);
